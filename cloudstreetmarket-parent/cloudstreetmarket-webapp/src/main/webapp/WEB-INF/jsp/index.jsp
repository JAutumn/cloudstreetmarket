...
<head>
    ...
    <meta name="keywords"
          content="Cloudstreet market, Spring, Spring MVC, educational, tutorial, Spring MVC Cookbook, PACKT Publishing"/>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                <a href="markets" class="dropdown-toggle" data-toggle="dropdown">Prices and markets <b
                                        class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-header">Indices</li>
                                    <li><a href="indices-EUROPE">Indices by markets</a></li>
                                    <li class="divider"></li>
                                    <li class="nav-header">Stocks</li>
                                    <li><a href="/stock-search">All prices search</a></li>
                                    <li><a href="/stock-search-by-market">Search by markets</a></li>
                                    <li><a href="/stocks-risers-fallers">Risers and fallers</a></li>
                                </ul>
                            </li>
...
<div id="copyright">
    <!-- start: Container -->
    <div class="container">
        <p><a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> by BootstrapMaster, thanks
        </p>
    </div>
    <!-- end: Container  -->
</div>
