...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body,
        ...
        return new ResponseEntity<>(new ErrorInfo(ex, (body != null) ? body.toString() : null, status), headers, status);
    }
    ...
    @ExceptionHandler(
            {InvalidDataAccessApiUsageException.class, DataAccessException.class, IllegalArgumentException.class})
